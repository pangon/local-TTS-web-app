# GOAL-browser-ui: Browser-Based User Interface
...
- [ ] Users can enter text, trigger synthesis, and play back audio from a web browser
- [ ] The UI works on modern desktop browsers (Chrome, Firefox, Edge)
